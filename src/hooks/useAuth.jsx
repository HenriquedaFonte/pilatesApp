...
//         setProfile(currentSession.user.user_metadata || null)
//       } else {
//         setUser(null)
//         setProfile(null)
//       }
...
//     })
//     if (error) {
//       console.error('Sign in error:', error) // Adicionado para depuração
//       setLoading(false)
//       return { error }
//     }
...
//     if (error) {
//       console.error('Sign out error:', error) // Adicionado para depuração
//       setLoading(false)
//       return { error }
//     }
//     // handleSession will be called by onAuthStateChange
